...
const researchPapersData = [
  ...
  {
    id: "4",
    title: "Genetic Engineering for Crop Improvement",
    ...
    <View style={styles.container}>
      ...
      <View style={styles.sortContainer}>
        ...
        <TouchableOpacity onPress={() => handleSort("title")}>
          <Text style={styles.sortButton}>Title</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => handleSort("subject")}>
          <Text style={styles.sortButton}>Subject</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => handleSort("topic")}>
          <Text style={styles.sortButton}>Topic</Text>
        </TouchableOpacity>
      </View>
